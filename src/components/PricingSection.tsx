    ...
    <div className="container mx-auto">
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto items-start">
        {plans.map((plan, i) => (
          <div
            key={plan.name}
            className={`fade-in-up-delay-${i + 1} relative rounded-2xl border p-8 transition-all duration-300 hover:-translate-y-1 ${
              plan.popular
                ? "bg-primary text-primary-foreground border-accent shadow-2xl shadow-accent/20 scale-105"
